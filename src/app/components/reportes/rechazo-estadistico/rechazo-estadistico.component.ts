...
@Component({
  selector: 'app-rechazo-estadistico',
  templateUrl: './rechazo-estadistico.component.html',
  providers: [FormulaServicio, UserService],
  styleUrls: ['./rechazo-estadistico.component.css']
})
export class RechazoEstadisticoComponent implements OnInit {
